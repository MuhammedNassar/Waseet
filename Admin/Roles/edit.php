   ...
   if(Validation($title,1)){
     ...
     if(count($errors) > 0){
       ...
       $_SESSION['Message'] = $errors;
        ...
        // DB CODE ..... 
        $sql = "update users_types set user_type_name='$title' where user_type = $id";
        $op  = mysqli_query($con,$sql);
    ...
    <div class="container-fluid">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <form action="edit.php?id=<?php echo ($data['user_type']); ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputName" name="title" aria-describedby=""
                            placeholder="Enter Title"  value="<?php echo $data['user_type_name'];?>">
                    </div>
